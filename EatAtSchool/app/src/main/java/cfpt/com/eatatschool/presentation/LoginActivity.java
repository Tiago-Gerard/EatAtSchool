...
<<<<<<< HEAD
import cfpt.com.eatatschool.data.Outils.ServiceLogin;
import cfpt.com.eatatschool.data.Outils.UploadService;
 ...
 */
<<<<<<< HEAD
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, ServiceLogin.Callbacks, UploadService.Callbacks {
=======
...
<<<<<<< HEAD
    @Override
    public void onResponse(UserSerializable user) {
        Log.i("LOGIN ", "OK");
